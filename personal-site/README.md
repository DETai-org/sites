...
- `lib/blog/blog.base.ts` — метаданные и текст постов (контент хранится в виде обычных строк).
...
- Для добавления нового поста достаточно вставить текст в поле `content` в `lib/blog/blog.base.ts`.
