...
export default function Mission() {
  return (
    <Section id="mission" variant="dark">
      <div className="flex w-full max-w-[1120px] flex-col items-center gap-mobile-6 md:gap-8">
        <Heading
          level={2}
          color="soft"
        ...
        <div className="group w-full max-w-[1080px] px-mobile-2 md:px-2">
          <div className="detai-card-border detai-scan-border relative w-full min-h-[30rem] overflow-hidden rounded-[15px] md:aspect-[2/1] md:min-h-0">
            ...
            <div className="absolute inset-0 z-10 flex h-full w-full items-center justify-center p-mobile-1 md:p-3">
              <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden px-mobile-3 py-mobile-5 text-center md:h-[94%] md:w-[96%] md:px-10 md:py-12 paper--object-mobile paper-shape--scroll paper-edges--scroll md:paper--ambient">
