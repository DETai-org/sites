...
См. `post_slugs_policy.md` для правил, специфичных для постов.
...
Локализация slug постов — отдельный шаг и отдельная политика, потому что требует миграции структуры хранения и маршрутизации. См. `post_slugs_policy.md`. ❗❗
