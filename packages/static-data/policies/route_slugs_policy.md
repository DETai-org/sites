...
Если хочешь — в следующем сообщении я дам короткий чек-лист “как проверить по коду” (в каких файлах искать маршрутизацию и откуда берётся slug), чтобы мы не гадали по UI.
```
